...
pipeline {
  ...
  environment{
    def userpat= credentials('github_token_ak')
    ...
    def tag = "sampletag"
    //def PROJECT_URL = "https://github.com/jitpack/gradle-simple.git"
    //def PROJECT_URL = "https://github.com/anilkintala123/gradle-multi-project-sample.git"
    //def PROJECT_URL = "https://github.com/anilkintala123/neom-fss-neompay-card-api-test.git"
    def PROJECT_URL = "https://github.com/anilkintala123/neom-fss-neompay-card-api-test.git"
...
//   }
    ...
    //   steps {
    //     container('build') {
    //         sh './gradle-simple/gradlew clean jacocoTestReport sonarqube'
        ...
        container('build') {
            withSonarQubeEnv('sonar-server') {
              ...
              sh '''
                ...
                #./gradle-simple/gradlew clean jacocoTestReport sonarqube
